...
// process only ever mints tokens, it never serves the frontend itself.
...
server.listen(PORT, () => {
  console.log(`react secure-card-input example mint-token server listening on http://localhost:${PORT}`);
});
